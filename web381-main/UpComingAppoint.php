...
<hr style="margin-top: 1em;">
        ...
        <div class="flex flex-col bg-white px-12 pb-10">
            ...
            <?php
                    ...
                    $query="select count(*) as c from `appointment`,`pet`,`petowner` where PID=vpid AND ownerID = id AND (appointment_status='Pending' OR appointment_status='Accepted' OR appointment_status='Declined') ";
                 ...
                 <table class="w-full">
                    ...
                    $query2="select * from `appointment`,`pet`,`petowner` where PID=vpid AND ownerID = id  AND (appointment_status='Pending' OR appointment_status='Accepted' OR appointment_status='Declined') ";
             ...
             echo '
                    ...
                    <td> <span class="font-semibold text-5m app-color-black-1"> <div>'.$name.'</div> </td>

                    <td> <span class="font-semibold text-5m app-color-gray-1"> <div>'.$service.'</div> </td>

                    <td> <span class="font-semibold text-5m app-color-gray-1">'.$date.'</span> </td>

                    <td> <span class="font-semibold text-5m app-color-gray-1">'.$time.'</span> </td> ';
                            ...
                            if ($status == 'Accepted'){
                              echo'<td> <div class="app-bg-red-2 h-8 w-20 font-semibold text-sm flex justify-center items-center app-color-red-1 rounded-md" style="margin-right: 1.7em;"> Accepted</div>
                               ...
                               <td>
                            <span class="font-semibold text-5m app-color-gray-1"> <details><summary> Note </summary><p> '.$note.'</p></details></span>
                        </td>
                            
                              <td>
                                  <button style="--accent-color:rgb(0, 85, 255) ;" class="btn btn-background-slide"> <a href="edit.php?editid='.$ID.'"> Edit </button>
                                  <button class="btn1 btn-background-slide"> <a href="cancel.php?cancelid='.$ID.'"> Cancel </button>
                           </td>
                          </tr> ';}


                          else if ($status == 'Declined'){
                            echo ' <td> <div class="app-bg-red-2 h-8 w-20 font-semibold text-sm flex justify-center items-center app-color-red-1 rounded-md" style="color: rgb(194, 6, 6); position: relative; background: #fdd7d7; left: 14pt;" > Declined </div> 
                            </td>
            ...
            echo'</tbody> </table>';
                ...
                echo ' <div style="font-weight: 450; font-size: large; margin-bottom: 3em; margin-top: 2em; width: 100%;">You Have No Appointment</div> ';
